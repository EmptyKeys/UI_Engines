...
namespace EmptyKeys.UserInterface.Renderers
{
    ...
    /// </summary>
    public class FNARenderer : Renderer
    {
        /// <summary>
        /// The graphics device
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FNARenderer" /> class.
        /// </summary>
        ...
        public FNARenderer(GraphicsDevice graphicsDevice, int nativeScreenWidth, int nativeScreenHeight)
        {
        ...
        public override TextureBase CreateTexture(object nativeTexture)
        {
            ...
            return new FNATexture(nativeTexture);
        }
        ...
        public override TextureBase CreateTexture(int width, int height, bool mipmap, bool dynamic)
        {
            ...
            FNATexture texture = new FNATexture(native);
            return texture;
        }
        ...
        {
            return new FNAEffect(nativeEffect);
        }
