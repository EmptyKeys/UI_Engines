...
{
    /// <summary>
    /// Implements FNA specific input device
    /// </summary>
    public class FNAInputDevice : InputDeviceBase
    {
        private MouseStateBase mouseState = new FNAMouseState();
        private GamePadStateBase gamePadState = new FNAGamePadState();
        private KeyboardStateBase keyboardState = new FNAKeyboardState();
        private TouchStateBase touchState = new FNATouchState();
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FNAInputDevice"/> class.
        /// </summary>
        public FNAInputDevice()
            : base()
        {
